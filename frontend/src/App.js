  ...
  handleUpload = () => {
    ...
    axios
      ...
      .then(res => {
        ...
        this.setState({
          hierarchie: res.data.data['Hiérarchie de la flotte'],
    ...
    return (
      <div className="App">
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td>{this.state.hierarchie.H1}</td>
                <td>{this.state.hierarchie.H2}</td>
                <td>{this.state.hierarchie.H3}</td>
                <td>{this.state.hierarchie.H4}</td>
              </tr>
            </tbody>
          </table>
          <br/>
